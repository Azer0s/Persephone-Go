...
var noArgCommands = []string{"nop", "eq", "add", "sub", "mul", "div", "mod", "andi", "ori", "xori", "noti", "shl", "shr", "addf", "subf", "mulf", "divf", "pop", "ge", "le", "gt", "lt", "gef", "lef", "gtf", "ltf", "inc", "dec", "cbase", "and", "or", "xor", "not", "ret", "conc"}
